...
function CoursePage() {
  ...
  useEffect(() => {
    ...
    console.log(courseData);
      const fetchData = async () => {
        let responseData = await Get(`api/admin/courses/${id}`);
  ...
  return (
    <div className="App">
      <Header />
      <CourseMain title={courseData.courseName} creator={courseData.createdBy} price={courseData.price} currency={courseData.currency.currency} rating={courseData.averageRating} reviewAmount={courseData.numberOfReviews} />
